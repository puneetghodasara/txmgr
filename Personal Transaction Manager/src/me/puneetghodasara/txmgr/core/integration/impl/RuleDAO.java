package me.puneetghodasara.txmgr.core.integration.impl;
...
public class RuleDAO extends HibernateDaoSupport implements RuleRepository {
	...
	public boolean isRuleExist(String rule) {
		List<?> ruleList = this.getHibernateTemplate().findByNamedParam("FROM Rule r WHERE r.rule = :myrule", "myrule", rule);

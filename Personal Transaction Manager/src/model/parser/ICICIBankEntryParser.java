...
import model.db.CreditDebitEnum;
import model.db.Transaction;
import model.input.EntryParser;
import model.input.GenericStatementEntry;
...
public class ICICIBankEntryParser implements EntryParser {

	Logger logger = Logger.getLogger(ICICIBankEntryParser.class);
